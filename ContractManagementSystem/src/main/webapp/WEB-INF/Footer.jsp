...
<body>
  ...
  <div class="d-flex justify-content-around fixed-bottom bg-dark">
    ...
    <a class="nav-item badge badge-light" href="https://github.com/hopeful89" target="_blank">Brandon Stine</a>
    
    <a class="nav-item badge badge-light" href="https://github.com/TMShumway" target="_blank">Timothy Shumway</a>
