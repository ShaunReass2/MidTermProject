...
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (3, 'SD Midterm: backend', 'Remote', '2021-07-15', '2021-07-23', 0, 'All the Java coding through Eclipse IDE.', 1, 200, 'Normal school hours', 'Don\'t forget those semicolons.', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (4, 'SD Midterm: frontend', 'Remote', '2021-07-15', '2021-07-23', 0, 'Design each view / web page', 1, 150, 'Normal class time', 'utilize JSTL tags', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (5, 'SD Midterm: repository', 'Remote', '2021-07-15', '2021-07-23', 0, 'Create the repo on Github', 1, 175, 'ongoing', 'share with team members', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (6, 'SD Midterm: MySQL Workbench', 'Remote', '2021-07-15', '2021-07-23', 0, 'Create Database', 1, 50, 'ongoing', 'forward engineer', 1);
...
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (8, 'SD Final Projects', 'Remote', '2021-08-23', '2021-08-25', 0, 'Give final presentations on final projects', 1, 299, 'all day long', 'speak clearly', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (9, 'SD: Make Change', 'Remote', '2021-05-25', '2021-05-27', 0, 'Make change from a cash register', 0, 65, 'weekend', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (10, 'SD: FilmQuery', 'Remote', '2021-07-01', '2021-07-03', 0, 'Full CRUD operations for our Film DB', 0, 64, 'weekend', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (11, 'SD: PresidentsDAO', 'Remote', '2021-06-24', '2021-06-25', 0, 'Learning about DAO methods', 0, 8, 'in class lab', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (12, 'SD: CesarCipher', 'Remote', '2021-05-24', '2021-05-26', 0, 'Weekend project', 0, 34, 'weekend ', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (13, 'SD: FizzBuzz', 'Remote', '2021-05-15', '2021-05-17', 0, 'weekend project', 0, 32, 'weekend homework', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (14, 'SD CRUD Solo Project', 'Remote', '2021-07-01', '2021-07-03', 0, 'weekend project', 0, 54, 'weekend homework', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (15, 'SD: PreWork', 'Remote', '2021-04-21', '2021-05-10', 0, 'prework before cohort begins', 0, 124, 'before 1st day of class', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (16, 'SD: Jets Project', 'Remote', '2021-06-01', '2021-06-04', 0, 'Jets project with Scanner CRUD', 0, 46, 'weekend project', 'none', 1);
INSERT INTO `job` (`id`, `job_name`, `location`, `start_date`, `end_date`, `is_complete`, `job_description`, `authorized_overtime`, `total_man_hours`, `hours_of_operation`, `miscellaneous`, `user_id`) VALUES (17, 'SD: Blackjack Project', 'Remote', '2021-06-07', '2021-06-09', 0, 'Working Blackjack application', 0, 48, 'weekend homework', 'none', 1);
